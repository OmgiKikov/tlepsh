...
const en = {
	...
	"diagnosis.next.fix": "say “fix the first problem” (or name a mode) to prepare an exact proposal",
	"diagnosis.next.harder": "add harder cases, or /run again to measure stability",
	"diagnosis.next.repair": "repair the inconclusive evidence path, then /run again",

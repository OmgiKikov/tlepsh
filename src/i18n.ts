...
const en = {
	...
	"trace.noRuns": "No runs yet — say “test” and I will run the basket.",
	"refusal.declined": "Cancelled — nothing changed.",
	"refusal.nothing-yet": "There is nothing to work on yet.",
	"refusal.command": "That did not go through: {reason}",
	"traces.showing": "Showing",
	"traces.basketGone": "its basket is no longer published",
...
const ru: Record<MessageKey, string> = {
	...
	"trace.noRuns": "Прогонов ещё нет — скажи «тесты», и я прогоню набор.",
	"refusal.declined": "Отменено — ничего не изменилось.",
	"refusal.nothing-yet": "Пока не над чем работать.",
	"refusal.command": "Не получилось: {reason}",
	"traces.showing": "Показываю",
	"traces.basketGone": "его набор больше не опубликован",

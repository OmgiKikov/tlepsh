...
const en = {
	...
	"mode.fact.no-tool-call": "no tool was called in {runs} of {observed} failing runs",
	"mode.fact.tool-call-as-text": "{runs} replies printed a tool call as text instead of making one",
	"mode.fact.asks-a-question": "{runs} replies asked the user a question instead of answering",
	"mode.fact.mixed-script": "{runs} replies mixed writing systems",
	"mode.fact.empty-reply": "{runs} runs ended with no reply at all",
...
const ru: Record<MessageKey, string> = {
	...
	"mode.fact.no-tool-call": "ни одного вызова инструмента в {runs} из {observed} упавших прогонов",
	"mode.fact.tool-call-as-text": "в {runs} ответах вызов инструмента напечатан текстом вместо вызова",
	"mode.fact.asks-a-question": "в {runs} ответах агент задаёт вопрос вместо ответа",
	"mode.fact.mixed-script": "в {runs} ответах смешаны системы письма",
	"mode.fact.empty-reply": "{runs} прогонов закончились без ответа",

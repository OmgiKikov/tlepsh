...
const NOUNS = {
	...
	ru: {
		...
		"failure mode": ["режим отказа", "режима отказа", "режимов отказа"],
...
const ru: Record<MessageKey, string> = {
	...
	"impact.new-modes": "Новые режимы отказа ({modes}):",
	...
	"diagnosis.headline": "пройдено {pass}/{total} · режимов отказа: {modes}, из них по нескольким задачам: {systemic}",

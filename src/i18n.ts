...
const en = {
	...
	"rag.summary": "{searches} · Hit@k {hitAtK} · MRR {mrr} · citation {citation} · grounding {grounding}",
	...
	"rag.faithfulness-note": "Faithfulness: not measured. Answer overlap is deterministic token overlap, not entailment. Chunk bodies are never included in this view.",
	...
	"rag.diagnosis.answer-grounding-miss": "answer lacked source support",
	"rag.diagnosis.retrieved-and-supported": "retrieved and supported",
	...
	"version-card.check.cites-source": "Source citation or overlap",
...
const ru: Record<MessageKey, string> = {
	...
	"rag.summary": "{searches} · попадание@k {hitAtK} · MRR {mrr} · цитирование {citation} · опора ответа {grounding}",
	...
	"rag.faithfulness-note": "Достоверность ответа по источнику не измерялась. Пересечение ответа — это совпадение токенов, а не доказательство смысла. Тексты фрагментов здесь не показываются.",
	...
	"rag.diagnosis.answer-grounding-miss": "ответ не опирается на источник",
	"rag.diagnosis.retrieved-and-supported": "источник найден и поддерживает ответ",
	...
	"version-card.check.cites-source": "Ссылка или пересечение с источником",

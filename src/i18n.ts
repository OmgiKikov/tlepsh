...
const en = {
	...
	"onboarding.wrap.files": "Which files may AHDE edit?",
	...
	"onboarding.wrap.stopped": "Nothing was written. Tell me when you want to adopt it.",
	...
	"cmd.err.traces-rows": "/traces takes how many rows to show, for example /traces 30",
...
const ru: Record<MessageKey, string> = {
	...
	"onboarding.wrap.files": "Какие файлы можно править?",
	...
	"onboarding.wrap.stopped": "Ничего не записано. Скажите, когда захотите принять агента.",
	...
	"cmd.err.traces-rows": "/traces принимает число строк, например /traces 30",

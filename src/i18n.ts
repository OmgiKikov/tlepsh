...
const en = {
	...
	"workshop.contract-tests": "{passed}/{total} contract tests passed",
	"workshop.refused": "refused without a reason",
	"label.tool": "Tool",
...
const ru: Record<MessageKey, string> = {
	...
	"workshop.contract-tests": "контрактных тестов пройдено: {passed}/{total}",
	"workshop.refused": "отклонено без объяснения",

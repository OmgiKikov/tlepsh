...
const SEALED_ORIGIN_TEXT: Record<SealedExamOrigin | "operator", string> = {
	...
	"judge-generated-kb": ", written by the judge from the knowledge base, sealed unreviewed",
	"judge-generated-kb-reviewed": ", written by the judge from the knowledge base, reviewed by the operator",
};
